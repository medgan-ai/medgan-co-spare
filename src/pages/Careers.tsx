          ...
          <div className="container max-w-7xl mx-auto">
            <div className="text-center max-w-3xl mx-auto animate-on-scroll">
              ...
              <div className="flex justify-center">
                <Button
                  onClick={() =>
                    window.open("https://www.linkedin.com/company/medgan", "_blank")
                  }
        ...
        {showModal && (
          <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
            <div className="bg-white rounded-lg p-6 shadow-xl max-w-md w-full text-center">
              <h3 className="text-xl font-semibold mb-4">No Job Openings</h3>
              <p className="text-gray-700 mb-6">
                There are no job opportunities currently. Please check back later or connect with us on LinkedIn.
              </p>              <Button 
                className="bg-medgan-blue hover:bg-medgan-dark-blue text-white px-6 py-3"
